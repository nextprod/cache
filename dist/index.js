...
function run(event) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Select a command.
        if (params.save) {
            return yield save(dir, params.save);
        }
        else if (params.restore) {
            return yield restore(dir, params.restore);
        }
...
// Restore cache.
const restore = (dir, key) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const src = path_1.default.join(dir, `${key}.tgz`);
        if (!promise_fs_1.default.existsSync(src)) {
            return yield writeOutput(false);
        }
        // Cache hit.
...
const writeOutput = (hit) => __awaiter(void 0, void 0, void 0, function* () {
    const filepath = path_1.default.resolve(path_1.default.join(outputDir, "hit.json"));
    // Write secrets to json file.
    yield promise_fs_1.default.writeFileSync(filepath, JSON.stringify({ value: hit }));
});
...
const {isString, getType, isPlainObject, isArrayOf, map} = __webpack_require__(422)
...
const MiniPass = __webpack_require__(128)
...
const Yallist = __webpack_require__(779)
...
const constants = exports.constants = __webpack_require__(120)
const Minipass = __webpack_require__(128)
...
const optsArg = __webpack_require__(359)
const pathArg = __webpack_require__(286)

const {mkdirpNative, mkdirpNativeSync} = __webpack_require__(946)
const {mkdirpManual, mkdirpManualSync} = __webpack_require__(732)
const {useNative, useNativeSync} = __webpack_require__(74)
...
const {dirname} = __webpack_require__(277)
const {findMade, findMadeSync} = __webpack_require__(78)
const {mkdirpManual, mkdirpManualSync} = __webpack_require__(732)
...
const { resolve, parse } = __webpack_require__(277)
const pathArg = path => {
  if (/\0/.test(path)) {
...
const promisify = __webpack_require__(622)
...
// high-level commands
exports.c = exports.create = __webpack_require__(21)
exports.r = exports.replace = __webpack_require__(585)
exports.t = exports.list = __webpack_require__(140)
exports.u = exports.update = __webpack_require__(924)
exports.x = exports.extract = __webpack_require__(454)

// classes
exports.Pack = __webpack_require__(615)
exports.Unpack = __webpack_require__(155)
exports.Parse = __webpack_require__(137)
exports.ReadEntry = __webpack_require__(340)
exports.WriteEntry = __webpack_require__(305)
exports.Header = __webpack_require__(921)
exports.Pax = __webpack_require__(708)
exports.types = __webpack_require__(550)
...
// tar -c
const hlo = __webpack_require__(606)

const Pack = __webpack_require__(615)
const fs = __webpack_require__(747)
const fsm = __webpack_require__(724)
const t = __webpack_require__(140)
const path = __webpack_require__(277)
...
// tar -x
const hlo = __webpack_require__(606)
const Unpack = __webpack_require__(155)
const fs = __webpack_require__(747)
const fsm = __webpack_require__(724)
const path = __webpack_require__(277)
...
const types = __webpack_require__(550)
const pathModule = __webpack_require__(277).posix
const large = __webpack_require__(465)
...
const mkdirp = __webpack_require__(243)
const fs = __webpack_require__(747)
const path = __webpack_require__(277)
const chownr = __webpack_require__(777)
...
const MiniPass = __webpack_require__(128)
const zlib = __webpack_require__(817)
const ReadEntry = __webpack_require__(340)
const WriteEntry = __webpack_require__(305)
...
const fs = __webpack_require__(747)
const path = __webpack_require__(277)
const warner = __webpack_require__(294)
...
const warner = __webpack_require__(294)
const path = __webpack_require__(277)
const Header = __webpack_require__(921)
const EE = __webpack_require__(614)
const Yallist = __webpack_require__(779)
const maxMetaEntrySize = 1024 * 1024
const Entry = __webpack_require__(340)
const Pax = __webpack_require__(708)
const zlib = __webpack_require__(817)
...
module.exports = () => {
  ...
  const { join } = __webpack_require__(277)
  const getDirs = path =>
...
const hlo = __webpack_require__(606)
const Pack = __webpack_require__(615)
const Parse = __webpack_require__(137)
const fs = __webpack_require__(747)
const fsm = __webpack_require__(724)
const t = __webpack_require__(140)
const path = __webpack_require__(277)
...
const fsm = __webpack_require__(724)
const path = __webpack_require__(277)
const mkdir = __webpack_require__(365)
const mkdirSync = mkdir.sync
const wc = __webpack_require__(355)
const pathReservations = __webpack_require__(657)
...
const getFlag = __webpack_require__(334)
...
const hlo = __webpack_require__(606)
const r = __webpack_require__(585)
...
const warner = __webpack_require__(294)
const winchars = __webpack_require__(355)

const modeFix = __webpack_require__(490)
...
try {
  ...
  __webpack_require__(332)(Yallist)
} catch (er) {}
